...
var uploadForm = document.querySelector("#batchUploadForm");
uploadForm.addEventListener("submit", function (event) {
    event.preventDefault();
    uploadBatch(event.target);
});
var connection = new signalR.HubConnectionBuilder()
    .withUrl("/hub")
    .build();
connection.on("statusChanged", function (id, status) {
    var m = document.createElement("div");
    m.innerHTML = "<div class=\"message-author\">".concat(id, "</div><div>").concat(status, "</div>");
